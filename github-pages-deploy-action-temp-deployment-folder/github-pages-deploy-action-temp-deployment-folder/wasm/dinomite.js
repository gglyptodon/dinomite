...
*/
export function newGame(width, height, num_dinos) {
    wasm.newGame(width, height, num_dinos);
}

/**
*/
export function newGameDefault() {
    wasm.newGameDefault();
}
...
* @param {number} y
*/
export function checkPosition(x, y) {
    wasm.checkPosition(x, y);
}
...
* @param {number} y
*/
export function checkNeighbors(x, y) {
    wasm.checkNeighbors(x, y);
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('dinomite_bg.wasm', import.meta.url);
    }
    const imports = getImports();
